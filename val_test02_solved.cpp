...
//
//  Copy some values.
//  X = { 0, 1, 2, 3, 4, ?b, ?b, ?c, ?d, ?e }.
// As we can see, the latter half of the array is not initialized, which contains a lot of junk. 
// To avoid our result turn into garbage, we need also initialize the latter part.
  ...
  x[5] = x[6];
//
//  We can copying some non-initialized value.
// 
//
  for ( i = 0; i < 10; i++ )
  {
